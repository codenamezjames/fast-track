          ...
          <div className="bg-neutral-800 rounded-xl p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Input
                ...
                onChange={(e) =>
                  handleManualChange('calories', Number.parseInt(e.target.value) || 0)
                }
              />
              <Input
                type="number"
                ...
                onChange={(e) =>
                  handleManualChange('protein', Number.parseInt(e.target.value) || 0)
                }
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Input
                ...
                onChange={(e) =>
                  handleManualChange('carbs', Number.parseInt(e.target.value) || 0)
                }
              />
              <Input
                type="number"
                ...
                onChange={(e) =>
                  handleManualChange('fat', Number.parseInt(e.target.value) || 0)
                }
              />
            </div>
